...
window.safeLocalStorageGetJSON = function(key, fallback) {
    try {
        ...
        function showConfirm(title, message, confirmText, callback) {
            ...
            // FLIP Animation: Step 3 - Invert (璁＄畻宸紓骞跺弽鍚戝彉锟?
            if (origin && dialog) {
        ...
        window.execConfirm = function() {
            ...
            if (overlay._ppDeleteOrigin) {
                ...
                if (dialog) {
                    ...
                    // FLIP Animation for Close: 鑾峰彇锟斤拷前寮圭獥浣嶇疆
                    var dialogRect = dialog.getBoundingClientRect();
        ...
        window.closeConfirm = function() {
            ...
            async function saveUserInfo(name, isNewUser) {
                try {
                    ...
                    // 浼樺厛浠?__auth__ 璁板綍鑾峰彇娉ㄥ唽鏃堕棿閿涘牊娓舵潈濞侊級?
                    try {
                    ...
                    // 鍚庡锛氫粠鐜版湁 __user_info__ 涓锟?reg_time锛堢敤limit(1)鑰岄潪maybeSingle锛屽閿欏琛岋級
                    if (!regTime) {
                        try {
                    ...
                    // 灏濊瘯鎵惧埌鏈拷鏂颁竴鏉¤褰曞苟UPDATE锛堟瘮DELETE+INSERT鏇村彲闈狅紝閬垮厤RLS鎷掔粷DELETE锟?
                    var updated = false;
                    try {
                        ...
                        if (latest.data && latest.data.length > 0) {
                            ...
                            if (!updRes.error) {
                                updated = true;
                                console.log("saveUserInfo 馃?" + name + " 鐧诲綍鏃堕棿瀹稿弶娲块弬?UPDATE): " + userInfo.last_login);
                            }
                        }
                    } catch(e) {}
                    ...
                    if (!updated) {
                        ...
                        if (insertRes.error) {
                            ...
                            console.log("saveUserInfo 馃?" + name + " 鐧诲綍鏃堕棿瀹稿弶娲块弬?INSERT): " + userInfo.last_login);
                        }
                    }
                } catch(e) {
            ...
            window.openUserProfile = async function(userName) {
                ...
                // 瀵倹鍔犺浇澶村儚閸滃瞼娅ヨぐ鏇熸闂?
                try {
                    // 褰撳墠鐢ㄦ埛浼樺厛娴ｈ法鏁ocalStorage閺夊啫鈻夌紦瀛?
                    if (userName === currentUser) {
                        try {
            ...
            function compressImage(file, maxW, maxH, quality) {
                return new Promise(function(resolve, reject) {
                    ...
                    img.onload = function() {
                        ...
                        // 浣跨敤 createImageBitmap 灏嗗浘鐗囪В锟?缂╂斁鍑轰富绾跨▼
            ...
            window.handleAvatarUpload = async function(event) {
                ...
                try {
                    // 浠诲姟2锛氶噸鏋勪负锟较达拷锟?Supabase Storage 锟?avatars/ 鐩綍
            ...
            async function updateAllAvatars() {
                // 鏇存柊鎴戠殑椤甸潰閻ㄥ嫬銇旈崓蹇ョ礄localStorage閺夊啫鈻変紭鍏堬紙?
                try {
                    var cachedAvatars = window.safeLocalStorageGetJSON(AVATAR_CACHE_KEY, {});
                    if (cachedAvatars[currentUser]) {
                        avatarCache[currentUser] = cachedAvatars[currentUser];
            ...
            window.handleProfileCardClick = function() {
                if (currentUser) {
                    // 瀹歌尙娅ヨぐ鏇窗鎵撳紑娑撴眽璧勬枡璇︽儏
                    openProfileDetail();
                } else {
                    // 鏈櫥褰曪細锟津开碉拷录/注锟斤拷椤甸潰
                    openAuthModal('login');
                }
            };
            ...
            async function initUI() {
                ...
                if (currentUser) {
                    ...
                    // 锟斤拷锟斤拷鏈€杩戠櫥褰曟椂闂达紙椤甸潰姣忔锟斤拷閮藉埛鏂帮紝蹇呴』await纭繚鍐欏叆锟?
            ...
            // DEPRECATED_DO_NOT_EDIT ===================== [宸插簾寮僝 涓嬫柟锟?361琛屾湁锟斤拷锟斤拷鐗堟湰 =====================
            ...
            function saveViewHistory(entry) {
                ...
                // 閬垮厤閲嶅锟斤拷录锛堝悓涓拷锟矫伙拷鍚屼竴甯栧瓙鍙褰曚竴娆★級
            ...
            // DEPRECATED_DO_NOT_EDIT ====== [宸插簾寮僝 涓嬫柟锟?412琛屾湁锟斤拷锟斤拷鐗堟湰 ======
            ...
            function setupFeedInfiniteScroll() {
                ...
                // 锟?feed 搴曢儴娣诲姞涓拷锟?sentinel 鍏冪礌
            ...
            // DEPRECATED_DO_NOT_EDIT ====== [宸插簾寮僝 涓嬫柟锟?479琛屾湁锟斤拷锟斤拷鐗堟湰 ======
            ...
            // DEPRECATED_DO_NOT_EDIT ====== [宸插簾寮僝 涓嬫柟锟?503琛屾湁锟斤拷锟斤拷鐗堟湰 ======
            ...
            // DEPRECATED_DO_NOT_EDIT ====== [宸插簾寮僝 涓嬫柟锟?532琛屾湁锟斤拷锟斤拷鐗堟湰 ======
            async function renderFeed({ posts, comments, likes }) {
                ...
                // 浠诲姟5锛氬彧娓叉煋绗竴椤电殑锟斤拷锟斤拷锛屽悗缁拷锟借繃鏃犻檺婊氬姩锟斤拷锟斤拷
            ...
            // 棰勬瀯寤鸿瘎璁哄拰锟斤拷锟斤拷鐨勬槧灏勮〃锛屾彁鍗囨覆鏌撴€ц兘
            ...
            async function loadAvatarsForUsers(usernames) {
                ...
                try {
                    var allData = [];
                    var batchSize = 80; // Supabase .in() 鏈€澶氱害100涓」锛岋拷?0浣欓噺
            ...
            // DEPRECATED_DO_NOT_EDIT ====== [宸插簾寮僝 涓嬫柟锟?520琛屾湁锟斤拷锟斤拷鐗堟湰 ======
            ...
            async function updatePostRecord(post, updates) {
                ...
                try {
                    ...
                    if (!matchesPostExpectation(verifiedFallback, expectedState)) {
                        return { ok: false, error: new Error("甯栧瓙鏇存柊鍚庣姸鎬佹湭瀹為檯淇濆瓨") };
                    }
            ...
            window.doPublish = async function () {
                ...
                try {
                    ...
                    showToast("发布失败: " + (e.message || "缃戠粶閿欒"));
                } finally {
                    btn.disabled = false;
            ...
            // DEPRECATED_DO_NOT_EDIT ====== [宸插簾寮僝 涓嬫柟锟?668琛屾湁锟斤拷锟斤拷鐗堟湰 ======
            ...
            window.openStatDetail = async function(type) {
                ...
                // 濡傛灉鏈夌紦瀛樻暟鎹紝锟斤拷锟斤拷娓叉煋锛屽悓鏃跺紓姝ュ埛锟?
            ...
            window.openPostDetail = async function(postId) {
                ...
                try {
                    ...
                    if (!canViewPost(post)) {
                        document.getElementById('postDetailBody').innerHTML = '<div class="stat-empty">鏃犳潈锟介看杩欐潯甯栧瓙</div>';
                        return;
                    }
            ...
            function formatPostSummary(p) {
                ...
                if (hasVid) tag = '<span class="spi-img-tag">馃帪 瑙嗛</span>';
            ...
            function renderPostStats() {
                ...
                if (!entries.length) {
                    body.innerHTML = '<div class="stat-empty">鏆傛棤鍔拷锟芥暟锟?/div>';
                    return;
                }
                ...
                body.innerHTML = entries.map(([name, posts]) => `
                    <div class="stat-user-group">
                        <div class="stat-user-header">
                            ...
                            <span class="suh-count">$${posts.length} 条閺?/span>
                        </div>
                        <div class="stat-user-posts">
                            ${posts.slice(0, 3).map(p => renderPostItemHTML(p)).join('')}
                            ${posts.length > 3 ? `
                                <div style="text-align:center; padding:8px 0;">
                                    <button class="stat-view-btn" onclick="loadUserAllPosts('${escapeHtml(name).replace(/'/g, "\\'")}')">锟介看鍏ㄩ儴 $${posts.length} 条锟?/button>
                                </div>
                            ` : ''}
                        </div>
                    </div>
            ...
            window.loadUserAllPosts = function(userName) {
                ...
                body.innerHTML = `
                    ...
                    <div style="font-weight:700; font-size:15px; margin-bottom:12px; padding:8px 0; border-bottom:1px solid rgba(255,255,255,0.1);">
                        ${userName} 鐨勫叏閮ㄥ笘瀛愶紙锟?${userPosts.length} 鏉★級
                    </div>
                    ${userPosts.map(p => renderPostItemHTML(p)).join('')}
                `;
            };

            // 娓叉煋鎬绘祻瑙堢粺璁★紙锟?localStorage 璇诲彇锟斤拷锟藉巻鍙诧拷?
                ...
                if (!history.length) {
                    body.innerHTML = `
                        <div class="stat-empty">
                            <div style="font-size:16px; margin-bottom:8px;">棣冩惓 娴忚璁板綍</div>
                            ...
                            <div style="font-size:12px; margin-top:8px; opacity:0.7;">褰撳墠宸茶褰曟€绘祻瑙堟暟锛?{document.getElementById('sViews').textContent} 濞?/div>
                        </div>
                    `;
                    return;
                }
                ...
                body.innerHTML = history.map(v => `
                    <div class="stat-view-item">
                        <div class="svi-info">
                            ...
                            <div class="svi-target">娴忚浜?<b>${escapeHtml(v.post_author)}</b> 閻ㄥ嫬绗樼€涙劧绱?{escapeHtml(v.post_content)}</div>
                        </div>
                ...
                function buildLikesCol() {
                    ...
                    if (statAllLikes.length) {
                        h += statAllLikes.slice(0, 200).map(l => {
                            ...
                            const postContent = post ? (post.content ? escapeHtml(post.content.slice(0, 20)) + '...' : '(鍥剧墖/瑙嗛)') : '(瀹告彃鍨归梽?';
                            return `
                        <div class="stat-like-item">
                            <div class="sli-info">
                                <div class="sli-user">${escapeHtml(l.user_name)}</div>
                ...
                function buildCommentsCol() {
                    ...
                    if (statAllComments.length) {
                        ...
                        <div class="stat-comment-item">
                            <div class="sci-info">
                                <div class="sci-user">${escapeHtml(c.user_name)}</div>
                                <div class="sci-target">璇勮浜嗗棎鈧?{postContent}閵嗗稄绱?{escapeHtml(c.content)}</div>
                            </div>
                            <span class="sci-time">${new Date(c.created_at).toLocaleString()}</span>
                        </div>
                    `;
            ...
            function showNotification(userName, message) {
                ...
                // 寮哄埗锟斤拷锟藉櫒瀹屾垚甯冨雹锟藉悗鍐嶆坊鍔爏how绫伙紝纭繚CSS transition姝ｇ‘瑙﹀彂
            ...
            // ==== 娴嬭瘯通知妯箙锛堟帶鍒跺彴璋冪敤锛歵estNotification()锟?====
            ...
            function startDMPolling(interval) {
                // 浠诲姟3锛氶粯璁ら棿锟?5 鍒嗛挓锟?00000ms锛夛紝闄嶄綆锟斤拷锟斤拷搴撹姹傚帇锟?
            ...
            window.switchDockTab = function(tab, skipReturn) {
                ...
                // 妫拷鏌ユ槸鍚︽槸鍙屽嚮刷锟斤拷锟?00ms鍐呭啀娆＄偣鍑诲悓涓拷tab锟?
                ...
                if (tab === currentDockTab && !skipReturn) {
                    if (isDoubleTap && !isRefreshing[tab]) {
                        ...
                        if (tab === 'posts') {
                            ...
                            // 锟斤拷锟斤拷椤碉細濡傛灉鍦ㄥ璇濅腑锛岃繑鍥炶亰澶╁垪琛紱鍚﹀垯鍥炲埌椤堕儴
            ...
            let _dockPreviewUrl = null;
                ...
                el.innerHTML = window.xtjMagicLoadingHtml ? window.xtjMagicLoadingHtml(title, subtitle, variant) : '<div class="xtj-magic-loading"><div class="xtj-magic-loading-title">' + escapeHtml(title) + '</div><div class="xtj-magic-loading-subtitle">' + escapeHtml(subtitle) + '</div></div>';
            }
            ...
            window.openChat = function(userName) {
                ...
                document.getElementById('dockChatMessages').innerHTML = window.xtjMagicLoadingHtml ? window.xtjMagicLoadingHtml('加载中', '正在打开聊天通道', 'chat-detail') : '<div class="chat-empty"><div class="ce-icon">💬</div><div>加载中</div></div>';
            ...
            async function loadDockChatList() {
                ...
                el.innerHTML = window.xtjMagicLoadingHtml ? window.xtjMagicLoadingHtml('加载中', '正在召回最近消息', 'chat-list') : '<div class="chat-empty"><div class="ce-icon">💬</div><div>加载中</div></div>';
                try {
            ...
            function renderDockMessages(msgs, forceScroll) {
                ...
                // 妫拷娴嬬敤鎴锋槸鍚﹀湪锟介看鍘嗗彶锟斤拷录锛堢搴曢儴锟斤拷锟斤拷100px瑙嗕负鍦ㄧ湅鍘嗗彶锟?
                ...
                // 鍏堥殣钘忓鍣紝娓叉煋瀹岀洿鎺ュ埌搴曞啀锟斤拷示锛岄伩鍏嶄粠椤堕儴婊戜笅鏉ョ殑闂儊
                var wasHidden = false;
            ...
            function showDockChatFilePreview(file) {
                ...
                if (file.type.startsWith('video/')) { thumb.innerHTML = '<span class="cfp-video-icon">馃帪</span>'; }
            ...
            window.addEventListener('DOMContentLoaded', async function() {
                ...
                (function() {
                    ...
                    // 浠诲姟4锛氫娇锟?100dvh 鏇夸唬 --vh 鏂规锛岀Щ锟?resize 鍥炶皟涓殑 adjustIOSHeight
                    // window.addEventListener('resize', function() {
                    //     if (!keyboardOpen) adjustIOSHeight();
                    // });
                })();

                // 浠诲姟4锛氫娇锟?100dvh 鏇夸唬 --vh 鏂规锛岀Щ闄ゆ棫锟?iOS 璋冩暣浠ｇ爜
                // adjustIOSHeight();
            ...
            // 鍒濆鍖栦富棰橈細锟斤拷锟斤拷 localStorage锛屽叾娆＄郴缁熷亸锟?
            ...
            const changelogData = [
                {
                    ...
                    content: `
                        <h4>Bug 修复与优化化</h4>
                        <ul>
                            <li>修复 core.js 语法结构错误导致页面完全空白、无法点击、无数据加载的问题</li>
                            <li>修复 dock-bar 遮罩层阻止点击交互的问题</li>
                            <li>优化弹窗关闭逻辑：ESC 键按优先级关闭所有活跃弹窗</li>
                            <li>完善 photo-wall 空数据与空引用保护的防御性编程</li>
                        </ul>
                    `
                },
                {
                    ...
                    content: `
                        <h4>鍔熻兘浼樺寲</h4>
                        <ul>
                            <li>绛涢€夊姛鑳戒紭鍖栵細灏嗗唴鑱旂瓫閫夋帶浠舵暣鍚堜负鎶樺彔寮?绛涢€?鎸夐挳闈㈡澘锛屾敮鎸佹椿璺冪瓫閫夎鏁板窘绔?/li>
                ...
                },
                {
                    ...
                    content: `
                        ...
                        <h4>椤圭洰浼樺寲</h4>
                        <ul>
                            <li>娓呯悊 js 澶囦唤鏂囦欢銆乻cripts 鐩綍銆乺oot 淇鑴氭湰绛夌害 110+ 鍐椾綑鏂囦欢</li>
                            <li>淇鏇存柊鏃ュ織椤甸潰涔辩爜闂</li>
                        </ul>
                    `
                },
                {
                ...
                },
                {
                    ...
                    content: `
                        <h4>鏇存柊鍐呭</h4>
                        <ul>
                            <li><strong>鍥剧墖鍒嗚鲸鐜囦竴鑷村寲浼樺寲</strong>
                                <ul>
                                    <li>缁熶竴缂╃暐鍥剧敓鎴愬弬鏁颁负1200x1200鍒嗚鲸鐜囷紝0.85鍘嬬缉璐ㄩ噺锛岀‘淇濆皝闈㈢缉鐣ュ浘涓庡疄闄呭唴瀹圭収鐗囧垎杈ㄧ巼姣斾緥鍜屾竻鏅板害鏍囧噯瀹屽叏涓€鑷?/li>
                    ...
                    content: `
                        ...
                        <ul>
                            <li><strong>閾炬帴澶嶅埗浼樺寲</strong>
                                <ul>
                                    <li>浼樺厛浣跨敤鍚屾API锛?lt;10ms锛夛紝鐐瑰嚮鍗虫椂鏄剧ず缁胯壊寮硅烦鍔ㄧ敾</li>
                                </ul>
                            </li>
                    ...
                    content: `
                        ...
                        <ul>
                            ...
                            <li><strong>鐩稿唽瑙嗗浘绌虹櫧淇</strong>
                                <ul>
                                    <li>鏁版嵁閾捐矾淇鍚庯紝鐩稿唽瑙嗗浘鍦ㄦ湁鐓х墖鏃惰兘姝ｇ‘娓叉煋"鎸夋棩鏈熷垎缁?鐨勭浉鍐屽垪琛?/li>
                ...
                },
                {
                    ...
                    content: `
                        ...
                        <ul>
                            ...
                            <li>鏇存柊"鎴戠殑"椤甸潰鐗堟湰鍙蜂负v0.0.28</li>
                        </ul>
                    `
                },
                {
            ...
            // 淇敼鍘熸湁锟?showAnnouncementList 浠ユ敮鎸佸綋鍓嶆爣绛剧姸锟?
        ...
        (function installMagicLoaderV3() {
            ...
            function patchNodeLoading(root) {
                ...
                root.querySelectorAll('.xtj-chat-loader, #feed .loading, #statModalBody .loading, #postDetailBody .loading, #dockChatMessages .chat-empty, #dockChatList .chat-empty, #postUserQuickList .post-user-chip--loading').forEach(function(node) {
                    ...
                    node.outerHTML = magicHtml('加载中', node.classList.contains('post-user-chip--loading') ? '筛选用户正在聚合' : '法阵正在聚能', variant);
                });
            }
        ...
        (function installCleanStatUiOverrides() {
            ...
            renderViewStats = function() {
                ...
                body.innerHTML = history.map(function(v) {
                    return '<div class="stat-view-item"><div class="svi-info"><div class="svi-user">' + escapeHtml(v.user_name) + '</div><div class="svi-target">娴忚浜?<b>' + escapeHtml(v.post_author) + '</b> 鐨勫笘瀛愶細' + escapeHtml(v.post_content) + '</div></div><span class="svi-time">' + new Date(v.viewed_at).toLocaleString() + '</span></div>';
                }).join('');
            };
            ...
            renderLikeStats = function() {
                ...
                function buildCommentsCol() {
                    var h = '<div class="stat-section-title">馃挰 璇勮璁板綍</div>';
                    if (statAllComments.length) {
