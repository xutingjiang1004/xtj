(function () {
  'use strict';
  if (window.__xtjFeaturesSafeV7) return;
  window.__xtjFeaturesSafeV7 = true;
  ...
  function fixText(v) {
    ...
    var pairs = [
      ...
      ['鏆傛棤', '暂无'], ['鏃犳潈', '无权'], ['甯栧瓙', '帖子'], ['鐧诲綍', '登录'], ['锛岃', '，请'], ['閲嶈瘯', '重试'], ['鍙栨秷', '取消'], ['鎻愴氦', '提交'], ['鎻愳氦', '提交'], ['鎻愪氦', '提交'], ['澶辫触', '失败'], ['鏈煡閿欒', '未知错误'],
  ...
  function patchToast() {
    if (typeof window.showToast !== 'function' || window.showToast.__xtjPatchedV7) return;
    ...
    window.showToast.__xtjPatchedV7 = true;
  }

  function patchChat() {
    if (typeof window.openChat === 'function' && !window.openChat.__xtjPatchedV7) {
      ...
      window.openChat.__xtjPatchedV7 = true;
    }
    if (typeof window.switchDockTab === 'function' && !window.switchDockTab.__xtjPatchedV7) {
      ...
      window.switchDockTab.__xtjPatchedV7 = true;
    }
  }

  function installMagicInteraction() {
    if (window.__xtjMagicInteractionInstalledV7) return;
    window.__xtjMagicInteractionInstalledV7 = true;
  ...
  function photoInfoAnim() {
    if (window.__xtjPhotoInfoAnimationFixInstalledV7 || typeof window.showPhotoInfo !== 'function') return;
    window.__xtjPhotoInfoAnimationFixInstalledV7 = true;
