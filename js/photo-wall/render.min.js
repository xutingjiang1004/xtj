(function(){
  ...
  function openPhotoWallPreviewAt(index, triggerEl){
    ...
    if ((!list || !list.length) && typeof window.openPhotoPreview === 'function') {
      return window.openPhotoPreview(nextIndex);
    }
    if (!list || !list.length || typeof window.openPhotoPreview !== 'function') return;
